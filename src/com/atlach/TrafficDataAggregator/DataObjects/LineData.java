...
/**
 * <b>LineData Object</b>
 * </br>Object used to represent Traffic Data for a single Line (i.e. segment of road)
 * @author francis
 *
 */
public class LineData {
	...
	public String toString() {
		return ("loc: " + Constants.locStr[locNameCode + 128] + 
				", sb:" + round(getSBTrafficAve(), 2) + 
					//"(" + (String.format("%6s", Integer.toBinaryString(trafficSB)).replace(' ', '0')) + ")" +
				", nb:" + round(getNBTrafficAve(), 2) + 
					//"(" + (String.format("%6s", Integer.toBinaryString(trafficNB)).replace(' ', '0')) +
					")");
	}
}
